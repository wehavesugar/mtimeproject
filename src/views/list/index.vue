...
.movie_img .i_hot {
  ...
  width: 0.73rem;
  height: 0.73rem;
  background: url(../../../static/img/i_hot.png) no-repeat 0 0;
}
...
.movie_detail .i_dot {
  ...
  width: 0.3rem;
  height: 0.25rem;
  background: url(../../../static/img/i_dot_01.png) no-repeat 0 0;
...
.info_3D {
  display: inline-block;
  background: url(../../../static/img/ia_cine_05.png) no-repeat 0 0;
  width: 0.4rem;
  height: 0.3rem;
}
.info_screen {
  display: inline-block;
  background: url(../../../static/img/ia_cine_15.png) no-repeat 0 0;
  width: 1rem;
  height: 0.3rem;
}
.fuc {
